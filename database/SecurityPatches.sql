...
-- Hardening applied after the initial schema went live.
-- Run AFTER schema.sql, functions.sql, triggers.sql, rls_policies.sql.
-- =========================================================
...
-- Belt-and-suspenders: also revoke from PUBLIC directly
